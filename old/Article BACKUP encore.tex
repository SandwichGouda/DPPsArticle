...
\begin{align*}
    ...
    &= \sum_{k \ge 0} \frac{b_k^2}{1-b_k} - \frac{a_k^2}{1-a_k} \\
    &= \sum_{k \ge 0} u_k  \\
    < +\infty
\end{align*}
...
Denote $B_n$ the $n$-th Bernoulli random variable (see Theorem 7), we have $ B_n \sim \mathrm{Ber} (\lambda_n) $. 
...
%     &= \mathbf P\left[ \left( \frac{1}{1-c} \right)^S \\
%     &\leqslant \left( \frac{1}{1-c} \right)^{(1-c)N_R} \right] \\
%     &= \mathbf P\left[ (1-c)^{(1-c)N_R} \\
%     &\leqslant (1-c)^{S} \right] \\
%     &\leqslant (1-c)^{-(1-c)N_R} \mathbf E[(1-c)^{S} ] \\
%     &= e^{\displaystyle -(1-c)N_R \log(1-c) }  \mathbf E\left[ e^{ \log (1-c) \sum\limits_{n=0}^\infty B_n } \right]  \\
%     &= e^{\displaystyle -(1-c)N_R \log(1-c) } \prod_{n=0}^\infty \mathbf E[ e^{ \log (1-c) B_n } ] \\
%     &= e^{\displaystyle -(1-c)N_R \log(1-c) } \prod_{n=0}^\infty (1-R^{2n+2} + R^{2n+2}(1-c)) \\
%     &= e^{\displaystyle -(1-c)N_R \log(1-c) } \prod_{n=0}^\infty (1-cR^{2n+2}) \\
